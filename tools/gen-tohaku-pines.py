...
VX = max(0, math.floor(min(t.ink[0] for t in trees)))
VY = max(0, math.floor(min(t.ink[1] for t in trees)))
VW = min(W, math.ceil(max(t.ink[2] for t in trees))) - VX
VH = min(H, math.ceil(max(t.ink[3] for t in trees))) - VY
